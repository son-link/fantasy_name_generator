...
class GUI():
	def __init__(self):
		...
		if not access('txt', R_OK):
			...
			self.liststore.append(['drow', _('Drow/Elfo Oscuro'), True])
			self.liststore.append(['elf', _('Elfo'), False])
			self.liststore.append(['hafling', 'Hafling', True])
			self.liststore.append(['dwarven', _('Enanos'), True])
			self.liststore.append(['gnome', _('Gnomos'), True])
			self.liststore.append(['demons', _('Demonios'), False])
			self.liststore.append(['dragons', _(u'Dragones'), False])
			self.liststore.append(['orcs', _('Orcos'), False])
			...
			liststore2.append(['male', _('Masculino')])
			liststore2.append(['female', _('Femenino')])
	...
	def view_info(self, widget):
		...
		info.set_translator_credits(_('Ingles: Son Link'))
